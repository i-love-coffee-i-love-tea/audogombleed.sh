...
#
# Tests for global help header (zsh)
#
...
@test "zsh: global help header appears at top of output" {
    run _zsh_run ?
    assert_success
...
# bats test_tags=id:zsh-182
@test "zsh: global help header shows all lines" {
    run _zsh_run ?
    assert_success
...
# bats test_tags=id:zsh-183
@test "zsh: global help header appears before section headings" {
    run _zsh_run ?
    assert_success
...
# bats test_tags=id:zsh-184
@test "zsh: global help header has 2-space indent" {
    run _zsh_run ?
    assert_success
...
# bats test_tags=id:zsh-185
@test "zsh: global help header does not appear in filtered command help" {
    run _zsh_run alpha ?
    assert_success
...
# bats test_tags=id:zsh-186
@test "zsh: no global header when config has none" {
...
@test "zsh: # lines without blank line are section headings, not global header" {
