...
# bats test_tags=id:bash-234
@test "bash: scoped &function loading calls only relevant &function" {
...
@test "bash: scoped &function loading calls different function for different command" {
    load '../_helpers/auto-completion-mock-setup'
