...
| **Exported variables** | persist in your shell | gone when subprocess exits |
| **Variable assignments** | persist in your shell | gone when subprocess exits |
| **`source` / virtualenv activation** | persists | gone |
